...
#[rustc_diagnostic_item = "builtin::strslice_is_ascii"] #[spec]
pub fn strslice_is_ascii<A>(_a: A) -> bool {
    unimplemented!()
}

#[rustc_diagnostic_item = "builtin::strslice_len"] #[spec]
pub fn strslice_len<A>(_a: A) -> usize {
    unimplemented!()
}

#[rustc_diagnostic_item = "builtin::strslice_get_char"] #[spec]
